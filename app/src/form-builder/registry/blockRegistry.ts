...
const headingConfigSchema = z.object({
...
const paragraphConfigSchema = z.object({
...
const shortTextConfigSchema = z
  ...
  .refine(
    (cfg) =>
      cfg.defaultValue === undefined || cfg.defaultValue.length <= cfg.maxLength,
    {
...
const singleSelectResponseSchema = z.object({
