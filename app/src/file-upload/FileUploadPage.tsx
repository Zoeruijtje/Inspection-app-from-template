...
export function FileUploadPage() {
  const [fileIdForDownload, setFileIdForDownload] = useState<File["id"]>("");
  ...
  useEffect(() => {
    if (fileIdForDownload.length > 0) {
      refetchDownloadUrl()
        ...
        .finally(() => {
          setFileIdForDownload("");
        });
    }
  }, [fileIdForDownload, refetchDownloadUrl]);
                      ...
                      <Card key={file.s3Key} className="p-4">
                        ...
                        >
                          ...
                          <div className="flex items-center justify-end gap-2">
                            <Button
                              onClick={() => setFileIdForDownload(file.id)}
                              disabled={
                                file.id === fileIdForDownload &&
                                isDownloadUrlLoading
                              }
